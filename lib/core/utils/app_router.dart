...
import 'package:dallal_proj/features/edit_adv_info_page/presentation/manager/edit_ad_orcstr_cubit/edit_ad_orcstr_cubit.dart';
...
import 'package:dallal_proj/features/more_page/presentation/views/contact_us_page.dart';
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          final vMsgModel = state.extra as VerifyMsgEntity;
